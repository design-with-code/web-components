...
/**
 * Method called by the switch theme button toggle between light and dark theme
 */
function toggleTheme(e){
    ...
    if(themeButton.pressed){
        // Switch icon to light and theme to dark
        themeButton.icon = "light-mode";
        this["sap-ui-webcomponents-bundle"].configuration.setTheme("sap_horizon_dark");
    }else{
        // Switch icon to dark and theme to light
        themeButton.icon = "dark-mode";
        this["sap-ui-webcomponents-bundle"].configuration.setTheme("sap_horizon");
    }
}
...
onload = () => {
    ...
    const themeButton = document.getElementById("themeButton");
    themeButton.addEventListener("click", (e) => toggleTheme(e));
